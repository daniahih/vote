...
const Login = () => {
  ...
  if (
    isLoggedIn &&
    (LoggedUser.type === "admin" || LoggedUser.type === "user")
  ) {
    // true
    ...
    return (
      <div>
        <p style={{ fontSize: "20px" }}>
          Welcome,<strong> {LoggedUser.name}</strong> keep your vote secret !
        </p>
    ...
    return (
      <div className="login-box">
        <div className="countainer">
          {/* <img className="countainer-img"></img> */}
          <form className="form" onSubmit={submitHandler}>
            <h1 className=""> Welcome to Voting Applicaton</h1>
            <label> Email</label>
            <input
              type="email"
              onChange={(e) => {
